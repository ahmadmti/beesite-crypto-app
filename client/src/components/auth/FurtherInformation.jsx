    ...
    const submit = (value) => {
        ...
        const res = ref.doc(user.uid).set({
            Qs1: {
                ...
                agree: certify,
                uploadId: uploadIdImage === null ? null : uploadIdImage,
                proofResidence :proofImage  === null ? null :proofImage
            },
            Qs2:ans2,
            Qs3:ans3,
            Qs4:ans4,
    ...
    return (
        <div className={classes.root}>
                            ...
                            <div className="padding">
                                <Grid item md={12} sm={12} xs={12}>
                                    <div className="submission_block">
                                        ...
                                        <Button variant="contained" onClick={handleNext} disabled={activeStep === 13} color="info" class="question_btn">
                                            Next Question
                                        </Button>
                                        <BottomBar />
                        ...
                        <div className="padding">
                            <Grid item md={12} sm={12} xs={12}>
                                <div className="submission_block">
                                    ...
                                    <Button variant="contained" onClick={handleSubmit} disabled={activeStep === 13} color="info" class="question_btn">
                                        Next Question
                                    </Button>
                                    <BottomBar />
            ...
            }
            {
                activeStep == 9 ?
                    <div className={classes.h3}>
                        <h3 className={classes.h3}> <span>10:</span>It's good, you have finished the process, we will send you by email the RIB on which to make your deposit once your account is validated.</h3>
                                        ...
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item md={12} sm={12} xs={12} >
                                                <Button
                                                    className="btn_style btn_id custom-file-upload">
                                                    <input type="file" onChange={handleImage} />
                                                    <i className="fa fa-download" />Deposit
                                        </Button>
                                                <div className="file-preview"></div>
                                            </Grid>
                        ...
                        <div className="padding">
                            <Grid item md={12} sm={12} xs={12}>
                                <div className="submission_block">
                                    ...
                                    <Button variant="contained" onClick={handleSubmit} disabled={activeStep === 15} color="info" class="question_btn">
                                        Next Question
                                        </Button>
                                    <BottomBar />
